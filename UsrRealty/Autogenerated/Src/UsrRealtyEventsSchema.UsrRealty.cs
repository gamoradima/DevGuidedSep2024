namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("220dd1d4-9a37-45f2-aed6-3381bc7a32bf");
			Name = "UsrRealtyEvents";
			ParentSchemaUId = new Guid("50e3acc0-26fc-4237-a095-849a1d534bd3");
			CreatedInPackageId = new Guid("dd285bc3-9648-4672-954f-d2ee7a799149");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("3615cf46-c2a9-6d56-58ed-f9ecb331a3fa"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("dd285bc3-9648-4672-954f-d2ee7a799149"),
				CreatedInSchemaUId = new Guid("220dd1d4-9a37-45f2-aed6-3381bc7a32bf"),
				ModifiedInSchemaUId = new Guid("220dd1d4-9a37-45f2-aed6-3381bc7a32bf")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("220dd1d4-9a37-45f2-aed6-3381bc7a32bf"));
		}
